        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              `connect-src 'self' ${process.env.NODE_ENV === 'development' ? 'http://localhost:3050' : ''} https://twosix-backend-z6y5k.ondigitalocean.app https://*.twosixweb.com https://api.twosixweb.com https://*.sentry.io https://checkout.wompi.co https://www.google-analytics.com https://analytics.google.com https://www.google.com https://production.wompi.co https://www.facebook.com`,
